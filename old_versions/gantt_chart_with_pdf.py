...
# ===== SAVE INTERACTIVE HTML WITH PDF DOWNLOAD =====
# Add a custom HTML wrapper with PDF download functionality
html_string = '''
<html>
<head>
    <meta charset="utf-8" />
...
# Write the HTML file with the interactive chart
with open("gantt_chart_final.html", 'w') as f:
    f.write(html_string.replace('{plot_div}', fig.to_html(include_plotlyjs='cdn')))
